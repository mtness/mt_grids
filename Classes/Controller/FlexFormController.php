<?php
namespace MarkusTimtner\MtGrids\Controller;
...
class FlexFormController {
     ...
     * @return array
     */
    public function getResponsiveColumnOptions($config) {
        // default for 2 columns
        $defaultOption = array('50% (col-md-6)', 'col-md-6');
        return \MarkusTimtner\MtGrids\Controller\FlexFormController::getColumnOptions($config, $defaultOption);
    }
        ...
        switch ( $columnType ) {
            ...
            case 'mdCol':
                ...
                if ( isset($config['flexParentDatabaseRow']['pi_flexform']['data']) && count($config['flexParentDatabaseRow']['pi_flexform']['data']) == 0 ) {
                    $optionListStart = array($defaultOption,
                                             array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.notset', ' '));
                } else {
                    $optionListStart = array(array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.notset', ' '),
                                             $defaultOption);
                }
                ...
                $optionList = array_merge($optionListStart, array(array('66% (col-md-8)', 'col-md-8'),
                                                                  ...
                                                                  array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.moreWidth', '--div--'),
                                                                  ...
                                                                  array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.moreOptions', '--div--'),
                                                                  array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.hidden', 'hidden-md'),
                                                                  array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.visible', 'visible-md')));
                break;

            // small device with
            case 'smCol':
                $optionList = array(array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.notset', ' '),
                                    ...
                                    array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.moreOptions', '--div--'),
                                    array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.hidden', 'hidden-sm'),
                                    array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.visible', 'visible-sm'));
                break;
            ...
            case 'xsCol':
                $optionList = array(array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.notset', ' '),
                                    ...
                                    array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.moreOptions', '--div--'),
                                    array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.hidden', 'hidden-xs'),
                                    array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.visible', 'visible-xs'));
                break;
            ...
            case 'lgCol':
                $optionList = array(array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.notset', ' '),
                                    ...
                                    array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.moreOptions', '--div--'),
                                    array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.hidden', 'hidden-lg'),
                                    array('LLL:EXT:mt_grids/Resources/Private/Language/locallang_db.xlf:grid.label.visible', 'visible-lg'));
                break;
        }
